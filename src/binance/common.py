...
def get_recv_window_ms() -> int:
    """Return the Binance signed-request receive window in milliseconds."""
    return DEFAULT_RECV_WINDOW_MS


def to_binance_kline_interval(interval: Any) -> str:
    """
    Convert interval aliases used by the bot (e.g. "60", "240") into Binance kline intervals.
    """
    if interval is None:
        return "1h"
