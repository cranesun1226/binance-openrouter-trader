"""CLI entrypoint for Binance OpenRouter Trader."""
...
def run_portfolio_strategy_cycle(
    *,
    state: Optional[Dict[str, Any]] = None,
    as_of_ms: Optional[int] = None,
) -> Dict[str, Any]:
    """Expose a single Binance OpenRouter Trader cycle for external callers and tests."""
...
def main_once() -> None:
    ...
    logger.info("=" * 60)
    logger.info("=== Binance OpenRouter Trader (once mode) ===")
    logger.info("=" * 60)
...
def main_scheduled() -> None:
    ...
    logger.info("=" * 60)
    logger.info("=== Binance OpenRouter Trader (scheduled mode) ===")
    logger.info("=" * 60)
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Binance OpenRouter Trader | six-slot USDT-M futures bot")
    parser.add_argument(
        "--once",
        action="store_true",
